...
import com.dsetanzania.dse.ListOfBondsAdapter;
...
public class BondsFragment extends Fragment {
    ...
    public void addBonds(int bondnumber,int bondrate,int bondyears){
        ...
        Bonds _bonds = new Bonds(id,bondnumber,bondrate,bondyears,getCurrentTimeStamp());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    Bonds _bonds = snapshot.getValue(Bonds.class);
                        bonds.add(_bonds);
                }
