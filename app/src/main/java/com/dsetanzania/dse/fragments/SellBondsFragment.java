...
public class SellBondsFragment extends Fragment {
    ...
    private void sellbonds(int units,int price,double consideration) {
        ...
        BondTransactionModel bondTransaction = new BondTransactionModel(id,firebaseUser.getUid(),bondspinner.getSelectedItem().toString(),"Successfully",consideration,"Sales",units,price,getCurrentTimeStamp());
