...
public class BussinessNewsFragment extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public static BussinessNewsFragment newInstance(int page, String title) {
        BussinessNewsFragment bussinessNewsFragment = new BussinessNewsFragment();
        Bundle args = new Bundle();
        args.putInt("someInt", page);
        args.putString("someTitle", title);
        bussinessNewsFragment.setArguments(args);
        return bussinessNewsFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null){
            view = inflater.inflate(R.layout.fragment_bussiness_news, container, false);
            newsrecyclerview = (RecyclerView) view.findViewById(R.id.businessnewsrecyclerview);
            progressBar = (ProgressBar) view.findViewById(R.id.businessnewsLoader);
    ...
    public void getNews(){
        ...
        Call<ResponseModel> call = apiService.getBusinessNews("za","business",API_KEY);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if(response.body().getStatus().equals("ok")) {
                    ...
                    if(articleList.size()>0) {
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(BussinessNewsFragment.this::onItemClick);
