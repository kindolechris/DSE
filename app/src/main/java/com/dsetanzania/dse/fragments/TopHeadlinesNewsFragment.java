 ...
 * Use the {@link TopHeadlinesNewsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TopHeadlinesNewsFragment extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public static TopHeadlinesNewsFragment newInstance(int page, String title) {
        TopHeadlinesNewsFragment topHeadlinesNewsFragment = new TopHeadlinesNewsFragment();
        Bundle args = new Bundle();
        args.putInt("someInt", page);
        args.putString("someTitle", title);
        topHeadlinesNewsFragment.setArguments(args);
        return topHeadlinesNewsFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null){
            ...
            newsrecyclerview = (RecyclerView) view.findViewById(R.id.topheadlinesnewsrecyclerview);
            progressBar = (ProgressBar) view.findViewById(R.id.headlinenewsLoader);
    ...
    public void getNews(){
        ...
        Call<ResponseModel> call = apiService.getTopHeadlinestNews("us",API_KEY);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if(response.body().getStatus().equals("ok")) {
                    ...
                    if(articleList.size()>0) {
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(TopHeadlinesNewsFragment.this::onItemClick);
