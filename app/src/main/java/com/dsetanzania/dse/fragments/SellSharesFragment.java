...
public class SellSharesFragment extends Fragment {
          ...
          /*          if(TextUtils.isEmpty(txtprice.getText().toString().trim()) || TextUtils.isEmpty(txtquantity.getText().toString().trim())){
                    ...
                    for(final SharesTransaction trns : transactionArray){
                        for (User usr : otherUserArray){
                            ...
                            if(usr.getId().equals(trns.getUserId()) && trns.getPrice() == Double.parseDouble(txtprice.getText().toString().trim()) && trns.getBoard().equals(boardSpinner.getSelectedItem().toString()) && trns.getType().equals("Purchase") && trns.getStatus().equals("Queued")){
    ...
    public void getUserInfo(){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                thisUserClass = dataSnapshot.getValue(UserModel.class);
    ...
    public void pushTransaction(String status,String boughtby,String date,String university){
        ...
        SharesTransactionModel tickets = new SharesTransactionModel("DSE" + generateguid(),Integer.valueOf(fuser.getUid()),status,getCurrentTimeStamp(),companyname,Double.parseDouble(txtprice.getText().toString().trim()),Integer.parseInt(txtquantity.getText().toString().trim()),"Sales",id,boughtby,date,university,"thidParty");
