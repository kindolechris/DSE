...
public class LiveMarket {
    ...
    public LiveMarket(String board, BigDecimal change, BigDecimal close, String company, BigDecimal high, BigDecimal lastDealPrice, Long lastTradedQuantity, BigDecimal low, BigDecimal marketCap, BigDecimal openingPrice, Date time, Long volume) {
        Board = board;
        Change = change;
        Close = close;
        Company = company;
