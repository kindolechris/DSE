...
public class SharesTransaction {
    ...
    public SharesTransaction(String id, String userId, String status, String date, String board, double price, int shareAmount, String type, String transId, String boughtOrSoldBy, String transactionSuccessfulldate, String universictyfrom, String transactionParty) {
