...
import com.dsetanzania.dse.activities.SimulatedBondsActivity;
...
public class SimulatedBondsAdapter extends RecyclerView.Adapter<SimulatedBondsAdapter.ViewHolder>  {
    ...
    public SimulatedBondsAdapter(Context context, List<Bonds> bonds) {
        this.bonds = bonds;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            buybtn = (Button) itemView.findViewById(R.id.btnbuybondsintent);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.txtbondduration.setText(String.valueOf(bonds.get(position).getMonth()) + " Month");
