...
public class OOUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    static HashMap< String, Class> classNames = new HashMap< String, Class>();
    
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^SecurityLivePrice",OOUSecurityLivePrice.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^InstrumentTurnoverFeed",OOUInstrumentTurnoverFeed.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^IndicesLivePrice",OOUIndicesLivePrice.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^InstrumentLiveFeed",OOUInstrumentLiveFeed.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^BondInformation",OOUBondInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^IndexBasisPointsInformation",OOUIndexBasisPointsInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^InstrumentInformation",OOUInstrumentInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^SectorInformation",OOUSectorInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^Indices",OOUIndices.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfSecurityLivePrice",OOUArrayOfSecurityLivePrice.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfInstrumentTurnoverFeed",OOUArrayOfInstrumentTurnoverFeed.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfIndicesLivePrice",OOUArrayOfIndicesLivePrice.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfInstrumentLiveFeed",OOUArrayOfInstrumentLiveFeed.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfBondInformation",OOUArrayOfBondInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfIndexBasisPointsInformation",OOUArrayOfIndexBasisPointsInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfInstrumentInformation",OOUArrayOfInstrumentInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfSectorInformation",OOUArrayOfSectorInformation.class);
        classNames.put("http://schemas.datacontract.org/2004/07/FeedWebService^^ArrayOfIndices",OOUArrayOfIndices.class);
    } 

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public OOUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OOUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OOUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName=OOUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OOUExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName=OOUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
