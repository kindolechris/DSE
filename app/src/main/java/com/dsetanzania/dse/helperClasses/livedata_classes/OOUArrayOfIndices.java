...
public class OOUArrayOfIndices extends Vector< OOUIndices> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, OOUExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                OOUIndices j1= (OOUIndices)__envelope.get(j,OOUIndices.class,false);
                add(j1);
            }
        }
    }
